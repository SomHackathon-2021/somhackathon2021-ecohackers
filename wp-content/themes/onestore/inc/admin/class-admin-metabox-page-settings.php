	...
	public function render_meta_box_fields__standard( $obj, $tab ) {
		...
		switch ( $tab ) {
			case 'header':
				...
				<?php if ( onestore_show_pro_teaser() ) : ?>
					<div class="notice notice-info notice-alt inline onestore-metabox-field-pro-teaser">
						...
						<p><?php echo esc_html_x( 'Enable / disable Transparent Header on this page.', 'OneStore Plus upsell', 'onestore' ); ?><br><?php echo esc_html_x( 'Enable / disable Sticky Header on this page.', 'OneStore Plus upsell', 'onestore' ); ?><br>
							<?php echo esc_html_x( 'Enable / disable Alternate Header Colors on this page.', 'OneStore Plus upsell', 'onestore' ); ?><br>
						</p>
			...
			case 'preloader-screen':
				if ( onestore_show_pro_teaser() ) : ?>
					<div class="notice notice-info notice-alt inline onestore-metabox-field-pro-teaser">
						<h3><?php echo esc_html_x( 'More Options Available', 'OneStore Plus upsell', 'onestore' ); ?></h3>
						<p><?php echo esc_html_x( 'Enable / disable Preloader Screen on this page.', 'OneStore Plus upsell', 'onestore' ); ?></p>
						<p><a href="<?php echo esc_url( add_query_arg( array( 'utm_source' => 'onestore-page-settings-metabox', 'utm_medium' => 'learn-more', 'utm_campaign' => 'theme-upsell' ), ONESTORE_PLUS_URL ) ); ?>" class="button button-secondary" target="_blank" rel="noopener"><?php echo esc_html_x( 'Learn More', 'OneStore Plus upsell', 'onestore' ); ?></a></p>
					</div>
				<?php endif;
				break;
			...
			case 'custom-blocks':
				if ( onestore_show_pro_teaser() ) : ?>
					<div class="notice notice-info notice-alt inline onestore-metabox-field-pro-teaser">
						<h3><?php echo esc_html_x( 'More Options Available', 'OneStore Plus upsell', 'onestore' ); ?></h3>
						<p><?php echo esc_html_x( 'Insert Custom Blocks (section / element) on any part of this page (header, footer, etc.).', 'OneStore Plus upsell', 'onestore' ); ?></p>
						<p><a href="<?php echo esc_url( add_query_arg( array( 'utm_source' => 'onestore-page-settings-metabox', 'utm_medium' => 'learn-more', 'utm_campaign' => 'theme-upsell' ), ONESTORE_PLUS_URL ) ); ?>" class="button button-secondary" target="_blank" rel="noopener"><?php echo esc_html_x( 'Learn More', 'OneStore Plus upsell', 'onestore' ); ?></a></p>
					</div>
				<?php endif;
				break;
