	...
	if ( onestore_show_pro_teaser() ) {
		$wp_customize->add_control(
			new OneStore_Customize_Control_Pro_Teaser(
				$wp_customize,
				'pro_teaser_page_settings_' . $ps_type,
				array(
					'section'     => $section,
					'settings'    => array(),
					...
					'features'    => array(
						esc_html_x( 'Enable Transparent Header on this page', 'OneStore Plus upsell', 'onestore' ),
						esc_html_x( 'Enable Alternate Header colors on this page', 'OneStore Plus upsell', 'onestore' ),
						esc_html_x( 'Enable Sticky Header on this page', 'OneStore Plus upsell', 'onestore' ),
						esc_html_x( 'Enable Preloader Screen on this page', 'OneStore Plus upsell', 'onestore' ),
					),
					'priority'    => 90,
				)
			)
